...
def config_parser():
    ...
    parser.add_argument("--train_noise_std", type=float, default=0.001,
                        help='will add noise to the training set') # change default value to change variance/ energy of the noise
